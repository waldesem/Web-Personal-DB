...
<template>
  ...
  >
    <form
      @submit.prevent="storeAdmin.dataUsers.submitUser"
    ...
    >
      <InputLabel
        ...
        @input-event="
          storeAdmin.dataUsers.form['fullname'] = $event.target.value
        "
      ...
      <InputLabel
        ...
        @input-event="
          storeAdmin.dataUsers.form['username'] = $event.target.value
        "
