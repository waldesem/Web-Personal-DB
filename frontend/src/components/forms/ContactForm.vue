...
const view = computed(() => {
  if (storeProfile.itemForm['view'] === 'Телефон') {
    return 'tel';

  } else if (storeProfile.itemForm['view'] === 'E-mail') {
    return 'email';
    ...
    <div class="mb-3 row">
      ...
      <div class="col-lg-10">
        <select class="form-select" id="view" name="view" 
                v-model="storeProfile.itemForm['view']">
    ...
    <div class="mb-3 row required">
      ...
      <div class="col-lg-10">
        <input class="form-control" id="contact" maxlength="250" name="contact" 
              required :type="view" v-model="storeProfile.itemForm['contact']">
      </div>
    </div>
    <div class=" row">
