...
<template>
   <form @submit.prevent="storeProfile.updateItem" class="form form-check" role="form">
    <div class="mb-3 row">
        ...
        <div class="col-lg-10">
        <select class="form-select" id="view" name="view" v-model="storeProfile.dataProfile.itemForm['view']">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-lg-10">
        <input class="form-control" id="series" maxlength="25" name="series" type="text" v-model="storeProfile.dataProfile.itemForm['series']">
        </div>
    </div>
    <div class="mb-3 row required">
        <label class="col-form-label col-lg-2" for="number">Номер документа</label>
        <div class="col-lg-10">
        <input class="form-control" id="number" maxlength="25" name="number" required type="text" v-model="storeProfile.dataProfile.itemForm['number']">
        </div>
    </div>
    <div class="mb-3 row">
        <label class="col-form-label col-lg-2" for="agency">Орган выдавший</label>
        <div class="col-lg-10">
        <input class="form-control" id="agency" maxlength="250" name="agency" type="text" v-model="storeProfile.dataProfile.itemForm['agency']">
        </div>
    </div>
    <div class="mb-3 row required">
        <label class="col-form-label col-lg-2" for="issue">Дата выдачи</label>
        <div class="col-lg-10">
        <input class="form-control" id="issue" name="issue" required type="date" v-model="storeProfile.dataProfile.itemForm['issue']" :max="new Date().toISOString().split('T')[0]">
        </div>
    </div>
    <div class=" row">
